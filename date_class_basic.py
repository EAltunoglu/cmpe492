...
def create_data_for_year(year: int):
    ...
    activity_sleep.to_csv(
        'merged_data/activity_sleep_daily_date_extended_class_{}.csv'.format(year), index=False)


create_data_for_year(2015)
create_data_for_year(2016)
